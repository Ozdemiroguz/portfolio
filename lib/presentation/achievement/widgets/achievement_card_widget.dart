...
class AchievementCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final title = TranslationHelpers.tryTranslate(achievement.titleKey, achievement.title);
    final description = TranslationHelpers.tryTranslate(achievement.descriptionKey, achievement.description);
    final issuer = TranslationHelpers.tryTranslate(achievement.issuerKey, achievement.issuer);
