...
class TetrisGameWidget extends StatefulWidget {
  const TetrisGameWidget({super.key});
    ...
    return Focus(
      ...
      child: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              TetrisHeaderWidget(score: score, level: level),
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                tr('tetris.score', namedArgs: {'score': score.toString()}),
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 14,
              ...
              Text(
                tr('tetris.level', namedArgs: {'level': level.toString()}),
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (isCurrentPiece) {
                ...
                cellColor = Colors.white.withValues(alpha: 0.1); // Boş hücreler
              }
