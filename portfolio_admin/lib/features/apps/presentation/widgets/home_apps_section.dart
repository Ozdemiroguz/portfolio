...
class HomeAppsSection extends ConsumerWidget {
  final String portfolioId;

  const HomeAppsSection({super.key, required this.portfolioId});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final homeAppsAsync = ref.watch(homeAppsProvider(portfolioId));
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  'home_apps_section_title'.tr(ref),
                  style: Theme.of(
                    context,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'no_home_apps_description'.tr(ref),
            style: Theme.of(
              context,
  ...
  void _showCreateAppDialog(BuildContext context, WidgetRef ref) {
    showDialog(
      ...
      builder:
          (context) =>
              CreateAppDialog(portfolioId: portfolioId, location: 'home'),
    );
  }
  ...
  void _reorderApps(
    ...
    ref
        ...
        .reorderApps(portfolioId, appIds, 'home');
  }

  void _deleteApp(WidgetRef ref, AppModel app) {
    ref.read(appNotifierProvider.notifier).deleteHomeApp(portfolioId, app.id);
  }
}
